<div class="text-center">
      ...
      <div>
            ...
            <form method="POST" action="<?= URL ?>compte/validation_modificationImage" enctype="multipart/form-data">
                  ...
                  <input accept=".jpg,.jpeg" type="file" class="form-control-file" id="image" name="image"
                        onchange="submit();" />
            </form>
      </div>
      <div id="mail">
            ...
            <div class="d-flex flex-column align-items-center mx-auto" style="margin: 96px; max-width: 700px">
                              ...
                              <div class="col custom-counter-item">
                                    <div class="custom-counter">
                                          <div class="custom-counter-avatar-container">
                                                <img class="custom-counter-avatar" src="https://picsum.photos/1000"
                                                      alt="image game">
                                          </div>
                  ...
                  <form class="w-100" action="<?= URL ?>validation_modificationImage" id="profilForm" method="POST">
                        ...
                        <div class="w-100 mb-4">
                              ...
                              <div class="mb-3">
                                    ...
                                    <input type="text" name="login" id="login" readonly class="input-field"
                                          placeholder="Your login" value="<?= $utilisateur['login'] ?>"
                                          require="required">
                              </div>
                        ...
                        <div class="w-100 mb-4">
                              ...
                              <div class="">
                                    <button class="card-button mb-3" type="submit" form="profilForm">Save the
                                          Changes</button>
                              </div>

                              <a href="<?= URL ?>compte/suppressionCompte" class="card-button-outline w-100">Supprimer
                                    son compte</a>
                        </div>
                  </form>
            </div>
