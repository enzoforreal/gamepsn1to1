      ...
      <div class="container-fluid">
            <div class="row">
                  ...
                  <aside class="chat-container">
                        ...
                        <aside
                              class="col-12 col-md-3 custom-background-light border-end border-bottom p-0 d-flex flex-column">
                              <p class="text-center m-3">CHAT PRIVEE</p>

                              <div class="d-flex flex-column">
                                    <div class="speech-bubble speech-other">
                                          <div class="d-flex flex-row">
                                                <img class="chat-avatar" src="https://picsum.photos/800"
                                                      alt="Avatar joueur 1">
                                                <div class="d-flex flex-column">
                                          ...
                                          <p class="chat-text">Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                                                Voluptate voluptatibus laboriosam ex
                                                officia excepturi magni, explicabo magnam. Similique odit maxime
                                                exercitationem aliquid reiciendis
                                    ...
                                    <div class="list-group list-group-flush scrollarea">
                                          ...
                                          <div class="speech-bubble speech-user">
                                                ...
                                                <p class="chat-text">Lorem ipsum dolor, sit amet consectetur adipisicing
                                                      elit. Voluptate voluptatibus laboriosam ex
                                                      officia excepturi magni, explicabo magnam. Similique odit maxime
                                                      exercitationem aliquid reiciendis
                                                      atque, consequatur aut ipsa possimus suscipit eaque!</p>
                                          </div>
            ...
            <main class="col">
                  <div class="row">
                              ...
                              <main class="col-12 col-md-9 custom-content">
                                    <div class="row">
                                          ...
                                          <div class="d-flex flex-row custom-playerList-item">
                                                ...
                                                <div class="col-12 col-xl-6 text-center mb-5">
                                                      <img src="../../public/Assets/images/img_room.png" alt=""
                                    ...
                                    <div class="list-group list-group-flush col-12 col-xl-6 mb-5">
                                          <div class="list-group-item">
                                                <div class="">
                                                      <div>
                                                            <h7 class="fw-bold">Partie crée par :
                                                                  <?= $utilisateur['login'] ?>
                                                            </h7>
                                                      </div>
                                                      <div class="d-flex w-100">
                                                            ...
                                                            <div class="custom-infoList-container">
                                                                  ...
                                                                  <h4 class="custom-infoList-item">Statut partie: privée
                                                                        (entre ami)</h4>
                                                                  <h4 class="custom-infoList-item">Identifiant partie:
                                                                        #47013</h4>
                                                            </div>
                        ...
                        <div class="col-12 row justify-content-md-between">
                              <a href="<?= URL; ?>partie" class="col-12 col-md-5 btn btn-outline-danger mb-3">Quit</a>
