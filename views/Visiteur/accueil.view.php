      ...
      <div class="container p-5 d-flex align-items-center h-100">
            <div class="row">
                  <div class="col-12">
                        ...
                        <p class="text-center fs-5">Win crypto by playing your favorite games, on your favorite platform by betting against other players</p>
                  </div>

                  <div class="col-12 text-center">
                        <img src="public/Assets/images/playstation-controller.png" class="img-fluid mt-5 mb-5" style="max-height: 400px;" alt="Responsive image">
                  </div>
 ...
 <div class="container-fluid d-flex align-items-center " style="min-height: 700px">
       <div class="container">
             <div
                   class="row d-flex flex-row justify-content-xl-between justify-content-center align-items-center p-5">
                   ...
                   <div class="col-xl-5 text-center">
                         <img src="public/Assets/images/controller cartoon.png" class="img-fluid mt-5 mb-5" style="max-height: 400px;"
 ...
 <div class="container-fluid d-flex align-items-center bg-light"  style="min-height: 700px">
       <div class="container">
             <div
                   ...
                   <div class="col-xl-5 text-center">
                         <img src="public/Assets/images/heart cartoon.png" class="img-fluid mt-5 mb-5" style="max-height: 400px;"
                               alt="Responsive image">
                   </div>
 ...
 <div class="container-fluid d-flex align-items-center " style="min-height: 700px">
       <div class="container">
             <div class="row d-flex flex-row justify-content-xl-between justify-content-center align-items-center p-5">
                   ...
                   <div class="col-xl-5 text-center">
                         <img src="public/Assets/images/information cartoon.png" class="img-fluid mt-5 mb-5" style="max-height: 400px;"
                               alt="Responsive image">
                   </div>
 ...
 <div class="container-fluid d-flex align-items-center bg-light ">
       <div class="container">
             <div class="row d-flex justify-content-center p-5" bg-light>
                   ...
                   <div class="col-12 text-center">
                         <img src="public/Assets/images/bitcoin cartoon.png" class="img-fluid mt-5 mb-5" style="max-height: 400px;"
